...
// Assembly colors
clamp_color                      = plastic_part_color("red");
clip_color                       = plastic_part_color("red");
d_shell_color                    = plastic_part_color([0.3, 0.5, 1, 1]);
d_shell_lid_color                = plastic_part_color("red");
d_motor_bracket_color            = plastic_part_color([0.3, 0.5, 1, 1]);
d_motor_bracket_lid_color        = plastic_part_color("red");
fixing_block_color               = plastic_part_color([0.3, 0.5, 1, 1]);
ribbon_clamp_color               = plastic_part_color("red");
fan_guard_color                  = plastic_part_color([0.3, 0.5, 1, 1]);
pcb_spacer_color                 = plastic_part_color([0.3, 0.5, 1, 1]);
pulley_color                     = plastic_part_color("red");
ribbon_clamp_color               = plastic_part_color("red");
wades_block_color                = plastic_part_color("yellow");
wades_big_gear_color             = plastic_part_color([0.3, 0.5, 1, 1]);
wades_small_gear_color           = plastic_part_color("red");
wades_idler_block_color          = plastic_part_color([0.3, 0.5, 1, 1]);
wades_gear_spacer_color          = plastic_part_color("red");
wades_clamp_color                = plastic_part_color("red");
x_carriage_color                 = plastic_part_color([0.3, 0.5, 1, 1]);
x_belt_clamp_color               = plastic_part_color("red");
x_end_bracket_color              = plastic_part_color([0.3, 0.5, 1, 1]);
y_bearing_mount_color            = plastic_part_color("red");
y_belt_anchor_color              = plastic_part_color("red");
y_belt_clip_color                = plastic_part_color("red");
y_idler_bracket_color            = plastic_part_color([0.3, 0.5, 1, 1]);
y_motor_bracket_color            = plastic_part_color([0.3, 0.5, 1, 1]);
z_coupling_color                 = plastic_part_color("red");
z_limit_switch_bracket_color     = plastic_part_color([0.3, 0.5, 1, 1]);
z_motor_bracket_color            = plastic_part_color([0.3, 0.5, 1, 1]);
